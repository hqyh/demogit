...
public class NotificationDemo {
    ...
    private synchronized void shoudGo() throws InterruptedException {
        while (go != true){
    ...
    private synchronized void go(){
        while (go == false){
            System.out.println(Thread.currentThread() + " is gong to notify all or one thread waiting on this object");
            go = true;
            notifyAll();
        }
    }
